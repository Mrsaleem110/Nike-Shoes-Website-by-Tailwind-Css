...
const hero = () => {
  return (
    ...
    <ul>
                   <li><h1 className='text-black font-bold text-4xl'>Welcome to the</h1></li>
                   <li><h1 className='text-black font-bold text-5xl' > NIKE WORLD</h1></li><br></br>
                   <li><h1 className='text-black font-bold text-3xl' >Your Own Shop<br></br>of World No1<br></br>Branded Shoes</h1></li><br></br>
